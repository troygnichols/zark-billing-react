...
export default {
  createInvoice: function(pipe, invoice, options) {
    ...
    invoice.items.forEach(function(item) {
      ...
      var quantityStr = options.currencySymbol + ' ' + item.quantity,
          unitPriceStr = options.currencySymbol + ' ' + item.unit_price,
          amountStr = options.currencySymbol + ' ' + item.amount;

      doc.font(mainFont, 8)
        .text(item.item_type, 50, y)
    ...
    var amountDue = 'TODO';
    var amountDueStr = options.currencySymbol + ' ' + amountDue;
